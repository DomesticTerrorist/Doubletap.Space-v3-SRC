...
{ (int)ItemDefinitionIndex::WEAPON_SG556,		"SG-556" },
...
const std::map<short, weapon_info> k_weapon_info = {
	...
	{ STUDDED_BLOODHOUND_GLOVES,{ "models/weapons/v_models/arms/glove_bloodhound/v_glove_bloodhound.mdl", "studded_bloodhound_gloves" } },
	{ CT_GLOVES,{ "models/weapons/v_models/arms/glove_hardknuckle/v_glove_hardknuckle.mdl" } },
	{ SPORTY_GLOVES,{ "models/weapons/v_models/arms/glove_sporty/v_glove_sporty.mdl", "sporty_gloves" } },
	{ SLICK_GLOVES,{ "models/weapons/v_models/arms/glove_slick/v_glove_slick.mdl", "slick_gloves"} },
	{ LEATHER_HANDWRAPS,{ "models/weapons/v_models/arms/glove_handwrap_leathery/v_glove_handwrap_leathery.mdl", "leather_handwraps" } },
	{ MOTORCYCLE_GLOVES,{ "models/weapons/v_models/arms/glove_motorcycle/v_glove_motorcycle.mdl", "motorcycle_gloves" } },
	{ SPECIALIST_GLOVES,{ "models/weapons/v_models/arms/glove_specialist/v_glove_specialist.mdl", "specialist_gloves" } },
	{ STUDDED_HYDRA_GLOVES,{ "models/weapons/v_models/arms/glove_bloodhound/v_glove_bloodhound_hydra.mdl", "studded_hydra_gloves" } }
};
...
const std::map<short, const char*> k_inventory_names = {
	...
	{SPORTY_GLOVES, "Sporty Gloves"},
	{SLICK_GLOVES, "Slick Gloves"},
	{LEATHER_HANDWRAPS, "Handwrap Gloves"},
	{MOTORCYCLE_GLOVES, "Motorcycle Gloves"},
