...
bool ImGui::ContentTab(const char* label, bool active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    const ImVec4 text_act = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
    const ImVec4 text_hov = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
...
bool ImGui::MainTab(const char* label, ImFont* icon_font, const char* icon, bool active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    const ImVec4 icon_act = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
...
bool ImGui::KeybindButton(const char* label, const char* unique_id, const ImVec2& size_arg, bool clicked, ImGuiButtonFlags flags)
{
    ...
    ImGui::GetWindowDrawList()->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, it_hover->second)), 2.f * c_menu::get().dpi_scale);
...
bool ImGui::CustomButton(const char* label, const char* label_id, const ImVec2& size_arg, bool use_icon, ImFont* icon_font, const char* icon_label)
{
    ...
    ImGui::GetWindowDrawList()->AddCircleFilled(it_circle->second.pos, it_circle->second.radius, GetColorU32(ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, it_circle->second.alpha)), 60);
...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, float* p_scroll_v, float size_avail_v, float size_contents_v, ImDrawCornerFlags rounding_corners)
{
    ...
    // Render
    ImVec4 hover_dis = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int* current_item)
{
    ...
    const ImVec4 hover_act = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
    const ImVec4 hover_dis = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);;
    ...
    const ImVec4 arrow_act = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
    const ImVec4 arrow_dis = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);;
...
bool ImGui::DragScalar(const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format, float power)
{
    ...
    const ImVec4 hover_act = ImVec4(235 / 255.f, 72 / 255.f, 72 / 255.f, 1.f);
    const ImVec4 hover_dis = ImVec4(230 / 255.f, 73 / 255.f, 73 / 255.f, 0.4f);;
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, bool minimum_damage, float power)
{
    ...
    const ImVec4 hover_act = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
    const ImVec4 hover_dis = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
    const ImVec4 hover_off = ImVec4(111 / 255.f, 0 / 255.f, 255 / 255.f, 1.f);
...
bool ImGui::tab(const char* name, bool active, ImVec2 size_arg) {
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    if (active) {
        ...
        window->DrawList->AddRectFilled(bb.Min, bb.Max - ImVec2(142, 0), ImColor(123, 0, 255,255));
