...
void aim::fire(CUserCmd* cmd)
{
	...
	if (hitchance_amount)
	{
		...
		{
			auto is_zoomable_weapon = g_ctx.globals.weapon->is_sniper() || g_ctx.globals.weapon->m_iItemDefinitionIndex() == WEAPON_AUG || g_ctx.globals.weapon->m_iItemDefinitionIndex() == WEAPON_SG556;
